  ...
  if (reduceMotion) {
    return (
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 50% 40% at 30% 40%, rgba(0,229,255,0.12) 0%, transparent 55%), radial-gradient(ellipse 45% 35% at 70% 60%, rgba(0,255,163,0.08) 0%, transparent 50%), #080C14',
        }}
        aria-hidden
      />
    )
  ...
  return (
    ...
    >
      <button
        ...
        className="flex w-full items-center justify-between px-6 py-5 gap-4 text-left cursor-pointer"
        onClick={() => setOpen((v) => !v)}
      >
    ...
    >
      ...
      <main className="flex-1 relative z-10">
        ...
        >
          ...
          <div
            className="hidden md:block absolute top-8 right-8 px-3 py-2 rounded-xl text-xs font-medium max-w-[200px] text-right leading-snug"
            style={{ background: 'rgba(0,229,255,0.06)', border: '1px solid rgba(0,229,255,0.15)', color: '#6B7FA8' }}
          >
            Visualização ilustrativa — seus volumes dependem do plano e da região.
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'A IA (OpenAI GPT-4o) analisa cada estabelecimento contra seu ICP e atribui score 0–100 com tier A/B/C/D e justificativa em português.',
                  tag: 'GPT-4o',
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Chat assistido por IA para cada lead. O agente usa o contexto do seu negócio e do contato para sugerir o próximo passo.',
                  tag: 'OpenAI',
                },
        ...
        <section className="py-16 sm:py-24 px-4 sm:px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-20">
              {[
                { line1: '100', line2: 'leads/mês', label: 'Plano Free incluído', color: '#00E5FF' },
                { line1: '0–100', line2: 'score', label: 'Qualificação por IA', color: '#00FFA3' },
                { line1: 'Maps', line2: '+ WhatsApp', label: 'Prospecção + contato', color: '#FFD600' },
                { line1: '< 5 min', line2: '', label: 'Primeira campanha guiada', color: '#A855F7' },
              ].map(({ line1, line2, label, color }) => (
                <div
                  key={label}
                ...
                >
                  <div
                    className="text-2xl sm:text-3xl font-black mb-0.5 tabular-nums leading-tight"
                    style={{ color, fontVariantNumeric: 'tabular-nums' }}
                  >
                    {line1}
                    {line2 ? (
                      <span className="block text-lg sm:text-xl font-bold mt-0.5" style={{ color: '#A8B8CC' }}>
                        {line2}
                      </span>
                    ) : null}
                  </div>
                  <div className="text-sm mt-2" style={{ color: '#6B7FA8' }}>{label}</div>
                </div>
              ))}
            </div>
            ...
            <div className="text-center mb-4">
              <h2 className="text-3xl font-black">Como equipes usam o Capturo</h2>
              <p className="text-xs sm:text-sm mt-2 max-w-xl mx-auto" style={{ color: '#3D4F6E' }}>
                Cenários ilustrativos — resultados reais dependem do nicho, região e execução.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                {
                  name: 'Marcos O.', role: 'Agência de marketing',
                  text: 'Quero escalar abordagem sem perder personalização: busco no mapa, a IA pontua o fit e mando mensagem única pelo WhatsApp.',
                  score: 5,
                },
                {
                  name: 'Ana P.', role: 'Consultoria B2B',
                  text: 'Preciso filtrar estabelecimentos antes de falar com humano. O score e o tier ajudam a priorizar quem merece follow-up.',
                  score: 5,
                },
                {
                  name: 'Pedro M.', role: 'SaaS / SDR',
                  text: 'Menos planilha e mais pipeline: campanha por região, Kanban com estágios e histórico do que foi enviado.',
                  score: 5,
                },
              ...
              {[
                {
                  ...
                  a: 'No onboarding você descreve seus serviços, público-alvo e diferenciais. Pode também colar a URL do seu site ou fazer upload de um PDF. A IA da OpenAI (GPT-4o) processa tudo e cria um perfil de ICP estruturado que guia toda a prospecção.',
                },
                {
                ...
                <FaqItem key={q} id={`faq-${i}`} q={q} a={a} />
              ))}
            </div>
          </div>
        </section>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-sm sm:text-base mb-8 max-w-lg mx-auto" style={{ color: '#6B7FA8' }}>
                  Cadastre-se em minutos: Maps, qualificação por IA e mensagens personalizadas no mesmo fluxo.
